...
import { 
  Building2, MessageCircle, LogIn, UserPlus, 
  LogOut, Shield, User, Download, Bell
} from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3.5">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5 w-full md:w-auto justify-end flex-wrap">
            ...
            <button
              onClick={onOpenWhatsAppModal}
              className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-blue-900/90 hover:bg-blue-800 text-xs font-bold text-white border-2 border-white transition shadow-sm"
              title="Pusat Notifikasi WhatsApp"
            >
              <MessageCircle className="w-4 h-4 text-emerald-400" />
              <span className="hidden sm:inline font-bold">Notifikasi WhatsApp</span>
              {waUnreadCount > 0 && (
            ...
            {/* Single-File HTML Button */}
            <button
              onClick={onOpenExportHtml}
              className="hidden lg:flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-xs font-semibold text-slate-100 border border-white/40 hover:border-white transition"
              title="Unduh Single-File HTML Mandiri"
            >
            ...
            {!currentUser ? (
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-sky-500 hover:bg-sky-600 text-xs font-black text-white border-2 border-white transition shadow-md"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-white hover:bg-slate-100 text-blue-950 text-xs font-black border-2 border-white transition shadow-md"
                >
